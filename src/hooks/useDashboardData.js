...
export function useDashboardData() {
    ...
    const fetchDashboardMetrics = async () => {
        ...
        try {
            ...
            const hotelAccom = onsiteRegs.filter(r => r.accommodation_type === 'Hotel').length;
            const noAccom = onsiteRegs.filter(r => !r.accommodation_type || r.accommodation_type === 'None').length;
