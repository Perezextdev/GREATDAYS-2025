// Priority countries displayed at top
...
export const COUNTRIES = [...PRIORITY_COUNTRIES, ...ALL_COUNTRIES.filter(
    country => !PRIORITY_COUNTRIES.find(p => p.code === country.code)
)];
